...
project = u'The Face Recognition Library (FaceRecLib)'
import time
copyright = u'%s, Idiap Research Institute' % time.strftime('%Y')

# Grab the setup entry
distribution = pkg_resources.require('facereclib')[0]
...
htmlhelp_basename = 'facereclib_doc'
...
man_pages = [
    ('index', 'facereclib', u'FaceRecLib Documentation', [u'Idiap Research Institute'], 1)
]
