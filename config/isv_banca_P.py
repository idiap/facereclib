...
protocol = 'P'
# ISV dimensionality (used in the path)
ru = 5 
base_output_USER_dir = "/idiap/user/lelshafey/banca/isv/U" + str(ru)
base_output_TEMP_dir = "/idiap/temp/lelshafey/banca/isv/U" + str(ru)
