...
# - UBMGMMVideoTool extends UBMGMMTool to support UBM training/enrolment/testing with video.FrameContainers
#
...
class ISVVideoTool (ISVTool, UBMGMMVideoTool):
  ...
  def train_enroler(self, train_files, enroler_file):
    ...
    ########## calculate GMM stats from video.FrameContainers, using frame_selector_for_train_enroler
    gmm_stats = [] 
