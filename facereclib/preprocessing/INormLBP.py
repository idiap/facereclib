...
class INormLBP:
  ...
  def __init__(self, config):
    ...
    real_h = config.CROP_H + 2 * config.OFFSET + 2 * config.RADIUS
    real_w = config.CROP_W + 2 * config.OFFSET + 2 * config.RADIUS
    real_oh = config.CROP_OH + config.OFFSET + config.RADIUS
