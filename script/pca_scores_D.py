...
def main():
  ...
  zfiles = db.Zobjects(directory=config.featuresProjected_dir, extension=config.featuresProjected_ext, protocol=config.protocol, groups=args.group)
  ...
  import pca
  pca.pca_ztnorm_D(tnorm_models_ids, config.tnorm_models_dir, zfiles, db, 
